        ...
        <div className="row">
            ...
            >
              <div className={style.heroImgCnt}>
                <div className={style.posRelFull}>
                  ...
                  >
                    <img src="https://www.oberoihotels.com/-/media/oberoi-hotel/alzorah-resized/Overview-Resized/other-destination/Dektop/India/Rajvilas.jpg" alt="" />
                    {/* <Image
                      src={heroImg ?? ""}
                      fill
          ...
          <div className="col-md-12">
            <div className={style.photoBy}>
              ...
              <span className={style.courtesy}>The Oberoi Rajvilas, Jaipur.</span>
            </div>
            {/* <StaticAds
              adUnits={[
                {
